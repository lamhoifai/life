...
function init_register_role_controller_toggle_right(app_root_url, role_id, plugin, controller, missing_aco_text)
{
    if (plugin.length) {
        ...
        var url = app_root_url + "admin/acl/aros/get_role_controller_permission/" + role_id + "/controller:" + controller;
    }
...
function register_role_toggle_right(start_granted, app_root_url, span_id, role_id, plugin, controller, action)
{
	if(start_granted)
	{
        if (plugin.length) {
            ...
            var url1 = app_root_url + "admin/acl/aros/deny_role_permission/" + role_id + "/controller:" + controller + "/action:" + action;
            var url2 = app_root_url + "admin/acl/aros/grant_role_permission/" + role_id + "/controller:" + controller + "/action:" + action;
        }
	}
	else
	{
        if (plugin.length) {
            ...
            var url1 = app_root_url + "admin/acl/aros/grant_role_permission/" + role_id + "/controller:" + controller + "/action:" + action;
            var url2 = app_root_url + "admin/acl/aros/deny_role_permission/" + role_id + "/controller:" + controller + "/action:" + action;
        }
	}
