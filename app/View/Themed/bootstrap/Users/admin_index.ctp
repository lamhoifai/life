...
<div class="page-header">
    <div class="btn-group pull-right">
        <?php echo $this->Html->link($this->BootstrapIcon->css('plus','white').' '.__('Add User'), array('action' => 'add'), array('class'=>'btn btn-primary btn-small','escape'=>false)); ?>
        <?php echo $this->Html->link($this->BootstrapIcon->css('search','white').' '.__('Search'), '#', array('data-state'=>'hide','data-toggle'=>'button','class'=>'btn btn-info btn-small btn-search','escape'=>false)); ?>
    </div>
...
<div class="row">
	<div class="span9 data">
		<table cellpadding="0" cellspacing="0" class="table table-striped">
			<tr>
				...
				<th><?php echo $this->Paginator->sort('callcenter_id');?></th>
		...
		foreach ($users as $user): ?>
			<tr>
                <td><span class="badge badge-inverse"><?php echo h($user['User']['id']); ?></span></td>
				<td><span class="label label-info"><?php echo h($user['Role']['name']); ?></span></td>
				<td><?php echo h($user['User']['full_name']); ?></td>
				<td><?php echo $this->Html->link($user['Callcenter']['name'],array('controller'=>'callcenters','action'=>'view',$user['Callcenter']['id'],'admin'=>true)); ?>&nbsp;</td>
    ...
    <div class="span3 filters">
        <p>
            <?php echo $this->Filter->filterForm('User', array('legend' => null)); ?>
        </p>
    </div>
</div>